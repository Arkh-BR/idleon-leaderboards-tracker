// Top-player AFK Gains Rate reference — metadata only (small, statically
...
// Highest AFK Gains Rate of a single real player, for context.
export const TOP_AFK_BEST = {"player":"kONYYY","char":"rajatkii","total":2199.383303443691};
