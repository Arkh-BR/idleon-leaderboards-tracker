...
export const TOP_DR_GENERATED_AT = "2026-05-29T02:59:05.859Z";
export const TOP_DR_PLAYERS_SCANNED = 71;
// Recomputed DR of the 'best of every source' synthetic save (higher
// than any single player). This is TOP_DR_FLAT['Drop Rate'].
export const TOP_DR_HYPOTHETICAL_TOTAL = 105796.00552375257;
// Highest DR of a single real player, for context.
export const TOP_DR_BEST = {"player":"Yisus1","char":"Aragorntt","total":76222.2631484442};
