...
export type CounterSource =
   ...
   *  RUNTIME-computed rollup not present in the raw save (arkh ports no
   ...
   *  a derived combat stat not ported in arkh. Returns 0 → inactive. */
...
export const TALENT_FINAL_BONUS_WRAPS: Record<number, TalentWrapSpec> = {
  ...
  // value the raw save does NOT contain (arkh ports no inventory/storage),
