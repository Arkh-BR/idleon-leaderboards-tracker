...
type Ctx = {
  saveData: SaveData;
  charIdx: number;
  resolve?: (descId: string) => { val: number; children?: ArkhNode[] } | null;
};
...
export function gfoodBonusMULTIBreakdown(
  ...
  const items = [
    ...
    { name: "famBonus (Family 66)", val: famBonus, arkh: 1.3774 },
    { name: "etcBonuses(8) Gold Food", val: etcG },
    { name: "Talent 99 (Hungry For Gold)", val: talent99, arkh: 48.8633 },
    { name: "Stamp Golden Food", val: stampG, arkh: 729.9845 },
    { name: "Achievement 37 (Nutty Crafter)", val: ach37, arkh: 5 },
    { name: "Bubble Shimmeron", val: alchG, arkh: 2487.5502 },
    { name: "Sigil 14 (Emoji Veggie)", val: sigil14, arkh: 420 },
    { name: "Meal Yumi Peachring", val: mealG, arkh: 31300 },
...
function gfoodMultiTreeChildren(
  ...
  const sourceKids: ArkhNode[] = restItems
