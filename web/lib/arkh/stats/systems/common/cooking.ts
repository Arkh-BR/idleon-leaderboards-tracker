...
// Comp162 is the CompanionBon value: 1 at stage 1, 1.6 at stage 2 (→ 40%).
...
export function cookingMealMulti(saveData: SaveData): MealMulti {
  ...
  const comp162 = saveData.companionIds.has(162)
    ? 25 * companionBonus(162, saveData.companionLv2Ids)
    : 0;
  const val =
