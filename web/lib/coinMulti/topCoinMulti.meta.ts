...
export const TOP_COIN_GENERATED_AT = "2026-09-23T18:16:56.902Z";
export const TOP_COIN_PLAYERS_SCANNED = 81;
// Best Coin Multi a single CLASS's best-of-each-source build reaches.
export const TOP_COIN_HYPOTHETICAL_TOTAL = 1.2747138613064826e+40;
// Highest Coin Multi of a single real player, for context.
export const TOP_COIN_BEST = {"player":"kONYYY","char":"Tapioviina","total":9.868369019397836e+37};
