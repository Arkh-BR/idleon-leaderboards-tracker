...
// newer than the last IdleonToolbox upload), passed into ProfileNameLoader
// as its children. `onLoad` gets the pasted text and says whether it loaded;
// the box is cleared only when it did.
export default function PasteSaveDetails({ onLoad }: { onLoad: (text: string) => boolean }) {
