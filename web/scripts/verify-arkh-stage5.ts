// Final wire-up: load ARKHE, run computeArkhDropRate, print the
// Arkh-style tree side-by-side with the descriptor's combine() output.
...
console.log(`[arkh-final] ${tree.name} → ${total.toFixed(4)}x\n`);
