...
import { arcade } from "../lib/arkh/stats/systems/w2/arcade";
import { voting } from "../lib/arkh/stats/systems/w2/voting";
import { postOffice } from "../lib/arkh/stats/systems/w2/postOffice";
import { prayer } from "../lib/arkh/stats/systems/w3/prayer";
import { shrine } from "../lib/arkh/stats/systems/w3/construction";
import { setBonus } from "../lib/arkh/stats/systems/w3/setBonus";
import { dream, cloudBonusSys } from "../lib/arkh/stats/systems/w3/equinox";
import { tome } from "../lib/arkh/stats/systems/w4/tome";
import { shiny } from "../lib/arkh/stats/systems/w4/breeding";
import { owl } from "../lib/arkh/stats/systems/w1/owl";
import { holes } from "../lib/arkh/stats/systems/w5/hole";
import { pristine } from "../lib/arkh/stats/systems/w5/pristine";
import { farm } from "../lib/arkh/stats/systems/w6/farming";
import { emperor } from "../lib/arkh/stats/systems/w6/emperor";
import { legendPTS } from "../lib/arkh/stats/systems/w7/legend";
import { spelunkShop } from "../lib/arkh/stats/systems/w7/spelunking";
import { guild } from "../lib/arkh/stats/systems/common/guild";
import { vault } from "../lib/arkh/stats/systems/common/vault";
import { equipment } from "../lib/arkh/stats/systems/common/equipment";
...
loadSaveData(raw);
console.log(`[arkh-stage3] Loaded — ${saveData.charNames.length} chars\n`);
...
console.log("\n[arkh-stage3] All systems resolved. Stage 3 OK.");
