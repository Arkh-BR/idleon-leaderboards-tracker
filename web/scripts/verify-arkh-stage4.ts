...
import { alchemy, sigil } from "../lib/arkh/stats/systems/w2/alchemy";
import { grid, chip, mainframeBonus, charHasChip } from "../lib/arkh/stats/systems/w4/lab";
import { tome } from "../lib/arkh/stats/systems/w4/tome";
import { grimoire } from "../lib/arkh/stats/systems/mc/grimoire";
import { arcaneMap, arcaneUpgBonus } from "../lib/arkh/stats/systems/mc/tesseract";
import { minehead, mineheadBonusQTY } from "../lib/arkh/stats/systems/w7/minehead";
import { sushiRoG, rogBonusQTY } from "../lib/arkh/stats/systems/w7/sushi";
import { winBonus, computeWinBonus } from "../lib/arkh/stats/systems/w6/summoning";
import { glimbo, workshop, eventShop } from "../lib/arkh/stats/systems/common/wrappers";
import { cookingMealMulti } from "../lib/arkh/stats/systems/common/cooking";
import { starSign, computeSeraphMulti } from "../lib/arkh/stats/systems/common/starSign";
import { computeArtifactBonus } from "../lib/arkh/stats/systems/w5/sailing";
import { galleryBonusMulti } from "../lib/arkh/stats/systems/w7/gallery";
import { lukScaling, lukCurve } from "../lib/arkh/stats/systems/common/stats";
...
loadSaveData(raw);
console.log(`[arkh-stage4] Loaded — ${saveData.charNames.length} chars\n`);
...
console.log("\n[arkh-stage4] All Stage 4 systems resolved. Stage 4 OK.");
