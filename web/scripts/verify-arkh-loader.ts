// Smoke test for Stage 1 of the Arkh port: feed an IT envelope to
...
console.log(`[arkh-loader] Loading ${SAVE_PATH}`);
...
console.log(`[arkh-loader] loadSaveData ran in ${ms}ms\n`);
...
console.log(
  `\n[arkh-loader] ${pass} passed, ${fail} failed (${
