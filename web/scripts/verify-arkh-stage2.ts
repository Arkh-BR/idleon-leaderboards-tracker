// Smoke test for Stage 2: load the ARKHE save into Arkh state, then
...
import { achievement } from "../lib/arkh/stats/systems/common/achievement";
import { companion, compMulti } from "../lib/arkh/stats/systems/common/companions";
import { card, cardSet, cardSingle } from "../lib/arkh/stats/systems/common/cards";
import { stamp } from "../lib/arkh/stats/systems/w1/stamp";
import { talent } from "../lib/arkh/stats/systems/common/talent";
import { goldenFood } from "../lib/arkh/stats/systems/common/goldenFood";

const SAVE_PATH =
  process.argv[2] ||
  "C:\\Users\\Vinicius\\ClaudeCowork\\Leaderboard Ranking Sheet - Idleon\\data from suport ARKHE.json";

console.log(`[arkh-stage2] Loading ${SAVE_PATH}`);
const raw = JSON.parse(readFileSync(SAVE_PATH, "utf8"));
loadSaveData(raw);
console.log(`[arkh-stage2] Loaded — ${saveData.charNames.length} chars, ` +
...
console.log("\n[arkh-stage2] If every line above ran without throwing, Stage 2 OK.");
