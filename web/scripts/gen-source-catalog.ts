...
(function () {
  ...
  var CUSTOM_FORMULAS = {
    ...
    "Archlord Of The Pirates (Talent 328)": function (_p, kids) {
      ...
      // talent.resolve(328) applies this wrap via TALENT_FINAL_BONUS_WRAPS
      // — the headline node is the talent name itself, with "Talent Value"
      // + "Plunderous Kills" exposed as direct kids so this handler can
      // recompute live when the user edits either input. Activity is
      // implicit (val > 0 ⇒ ≥1 owner-class char invested + plunder > 0).
