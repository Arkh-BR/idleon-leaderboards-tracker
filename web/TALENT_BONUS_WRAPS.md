...
| 643 (Coins For Charon) | max-damage engine | `overkillStuffs` on the saved map: tier = log_okExp(maxDmg / HP), 1..51; HP = the save's AFKtarget_N (curses, Clamz_HP), no FIGHTING gate; okExp = currentMap≥300 ? 5 : 2 |
